...
{
    public class ColumnBetTypeHandlerTests
    {
        [Fact]
        public void ValidatePosition_ValidatesPosition()
        {
            ...
            var betTypeHandler = new ColumnBetTypeHandler(mockBetTypeValidator);
        ...
        {
            var expectedValidationResult = new InvalidPositionValidationResult(null, BetType.Column);
            var mockBetTypeValidator = Substitute.For<IBetTypeValidator>();
            mockBetTypeValidator.ValidatePosition(Arg.Any<int?>()).Returns(expectedValidationResult);
            var betTypeHandler = new ColumnBetTypeHandler(mockBetTypeValidator);
        ...
        {
            var betTypeHandler = new ColumnBetTypeHandler(Substitute.For<IBetTypeValidator>());
        ...
        public void CalculatesWinnings_ReturnsExpectedWinnings()
        {
            ...
            result.AmountWon.Should().Be(expectedAmount * BetMultipliers.ColumnMultiplier);
        }
    }
}
